package com.brave.authority.datasource;
...
public class DruidDBConfig {
    ...
    @Value("${spring.datasource.shiro.url}")
    private String dbUrl1;

    @Value("${spring.datasource.shiro.username}")
    private String username1;

    @Value("${spring.datasource.shiro.password}")
